            ...
            <div className="w-[90%] sm:w-[70%] mx-auto grid grid-cols-1 xl:grid-cols-2 gap-10">
                ...
                <div>
                    ...
                    <div className="mt-10" data-aos="zoom-out" data-aos-anchor-placement="top-center" data-aos-delay="300">
                        <ResumeCard Icon={BiBadge} role="NIT Delhi" date="Jan 2023- Dec 2027" />
                        <ResumeCard Icon={FaReact} role="KV Vikaspuri" date="Jan 2020- Dec 2022" />
                        <ResumeCard Icon={BsDatabase} role="S.D. Public School" date="Jan 2018- Dec 2020" />
                    </div>
                </div>
            </div>
        </div>
